...
<% if(request.getParameter("id").toString().equals("success")) { %>
     <table class="table table-condensed table-bordered no-margin admin-list-table">
                  ...
                  <tbody>
                  <s:iterator value="adminsList" var="listOfAdmins">
                    <tr>
                      ...
                      <td>
	                      <%-- <span data-toggle="modal" data-target="#view"><a href="#" onclick="javascript:callAjx('vAdmins',<s:property value="userId" />)" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye"></i></a></span>  --%>
	                      <a href="<%=properties.getProperty("CONTEXT_PATH").toString() %>admin/adminEditAdminDetails.jsp" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></a> 
